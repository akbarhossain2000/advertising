...
$credit_link 		= 'http://www.deelko.com/';
$the_wp_link		= 'http://wordpress.org/';
$copyright_text 	= get_theme_mod( 'ac_footer_copyright_text', 'Copyright 2016 DEELKO. All rights reserved.' );
$logo_text			= get_theme_mod( 'ac_footer_logo_text', 'Advertising agency' );
?>
		<?php 
		...
		<footer id="main-footer" class="footer-wrap<?php ac_mini_disabled() ?> clearfix">
    		<aside class="footer-credits">
                ...
                <span class="theme-author">
                    <a href="<?php echo $the_wp_link; ?>">Proudly powered by Deelko</a> &mdash;
                    <em>Theme: Advertising agency by</em>
                    <a href="<?php echo $credit_link; ?>" title="Deelko">Deelko</a>
				</span>
                <?php endif; ?>
